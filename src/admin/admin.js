...
function displayTable(table) {
  ...
  tableHTML += "<thead>";
  tableHTML += "<tr>";
  tableHTML += '<th class="border p-2">Last Name</th>';
  tableHTML += '<th class="border p-2">First Name</th>';
  tableHTML += '<th class="border p-2">Patronymic</th>';
  tableHTML += '<th class="border p-2">Phone</th>';
  tableHTML += '<th class="border p-2">Email</th>';
  tableHTML += '<th class="border p-2">Username</th>';
  tableHTML += '<th class="border p-2">Password</th>';
  tableHTML += "</tr>";
  tableHTML += "</thead>";
  tableHTML += "<tbody>";
